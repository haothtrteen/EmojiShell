🌟 EmojiShell | 用emoji伪装你的 Shell 脚本

项目定位：

一个专注于 Emoji 编程技术 的 Shell 脚本工具库，通过将敏感代码转换为颜文字、符号组合和动态字体，实现 视觉迷惑。
...
```
#!/usr/bin/env zsh
🍒🎋🌍🍎🍒🚁🌛🐸🐸💞🍒💚() { printf "%s" "0"; };🐝🔥🐯🍆💚🐣🍒💗🖤🐗🌟💗() { printf "%s" "1"; };🌛🏗💙💞🍄🚀🐸🍁💙🔕🏗🏕() { printf "%s" "2"; };💚💙🍎🚫💚🐳🍒💕🍆💝❤🎁() { printf "%s" "5"; };🏗🍁🏗💙🍆💙🌛🏕🚀🏕🌶🔔() { printf "%s" "6"; };🐮🎋🐳🐬🎋🐗🐗💛💞🚁🐗🏟() { printf "%s" "7"; };🐷🐷💙💙💕💙🏝💕🏗🌶💗🐗() { printf "%s" "8"; };🐯🐯💞🍒🎁💜🐗🍒🌍💞🍒💙() { printf "%s" "9"; };💝🏡🐗💙💝🌍🏗💝💙🛑🎁🐬() { printf "%s" "A"; };🍭💚🌍💕💞💜💝🏟🐯🐷💛🐣() { printf "%s" "B"; };🏕🏡🍒💦💜🍄🚀🖤🏕🏕🐯🔕() { printf "%s" "C"; };💜🖤💔🎁🚁🍆🌛🏗🐮🖤🍆❤() { printf "%s" "D"; };💝🌛🐣🏕💛🐷🍁🐮🍭🏕🐮💕() { printf "%s" "E"; };💦💙💚🐷🐮🐮🐸🐗🍆🌟🍒💖() { printf "%s" "H"; };💕🐸🚀❤🐬🏝🍎❤🐮🍭💔🍭() { printf "%s" "I"; };💜❤🍒🛑🍄🚀💦🍒❤🍷🌶💛() { printf "%s" "K"; };🏝🌛🍒🐷🚀🌍🌶💞💞🐬🏡🔕() { printf "%s" "O"; };❣🐣💙🌤🚤🛑🐣💝🐣🏡🏕🌍() { printf "%s" "P"; };💙🚤🔔🐸🐷💛🐳🔔🐳💜🚫🍒() { printf "%s" "R"; };🏡🐮🐷🐗🔔🐮🍎🍒🐗🛑🚤💕() { printf "%s" "S"; };🍆🐗💗🚀💚💔🐬🚫🐬🔥💙💦() { printf "%s" "T"; };🐳🍒💗🐯💙🍄🚫🌍🍭🐷❤🐳() { printf "%s" "U"; };🐗🔔🏗🏕🐗🏕🏡🌛🍆🚤💕🏕() { printf "%s" "Y"; };🐣🏕🚫🏗🌶🍁🚁🛑🌍🌍🐞💙() { printf "%s" "a"; };🛑🛑🛑🐬🐗🌍🍎❤🐮💕💔❤() { printf "%s" "b"; };🚀🐬🏗💚🚀💙🍎💖🍄💙🚤🚤() { printf "%s" "c"; };💦💕🌍🐷🚀🐷🌍💙🌛🏕🐷🏡() { printf "%s" "d"; };🎁🐮🚫🏜💙🏟🌍🍁💙🚀💖💝() { printf "%s" "e"; };🍎🏟🌶💕🌶💙🔕💚🍄💦🐮🍎() { printf "%s" "f"; };🐮🐞💛💕🌛💦💝🏗🌍💛🐮🐝() { printf "%s" "g"; };🍎💔🐗💞🚀🍄🐯💙🌍🎁🌍🏝() { printf "%s" "h"; };🚀🍎🛑🐯🏗🍒💜💙🌍🚁🐳🐗() { printf "%s" "i"; };🚀💙🐸🐷🚀🐞💕💕🍭🐳🐮🚤() { printf "%s" "k"; };🌛🛑💝🚫🍄💚🐯❤💞🐬💖🌛() { printf "%s" "l"; };🐞🏗🐯💞💔🌶🎁🍭💕🏗🏗🐬() { printf "%s" "m"; };💜🐳🌶🐬🏕🍎💙🍄🌶🐷🌍🌛() { printf "%s" "n"; };💙🏝💜🌛🛑🌍💚🏗🏗🍷🚫💞() { printf "%s" "o"; };🌍🖤💛💜🚁️🐷🚫🐗🍒🍒🍄() { printf "%s" "p"; };🏡🍎🍒🐞🌍🐯💙🚀🌍💜🌍🖤() { printf "%s" "q"; };🐮🏕️🌟🔔❤🌍🐬🏗🌶💞🏗() { printf "%s" "r"; };🐣🚁💚🐬🐯🚁💙🍎🛑🍒🐬💛() { printf "%s" "s"; };🏡🌶🌶🏝🐬🎋🐳🍁🌛💝❤💙() { printf "%s" "t"; };🐗💚🐮🐸🌟💝🐞🏡🚫🐗💙🐯() { printf "%s" "u"; };🌍💔🐮🎋🍁🎁🏗🚫💗💙🍆❤() { printf "%s" "v"; };🏡💕🐳🛑🐮💚❤🔔🖤🐗🍆❤() { printf "%s" "w"; };🐯🛑🍷🔔💙💦🏜🐮💜🏟💞🐮() { printf "%s" "x"; };🏝💚🍆🏕🌟🎁💔🖤🐝🎁❤🐗() { printf "%s" "y"; };
